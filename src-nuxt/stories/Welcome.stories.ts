...
const WelcomePage = defineComponent({
  ...
  setup() {
    return () =>
      h('div', { style: 'max-width: 600px; margin: 2rem auto; font-family: system-ui, sans-serif; color: #333;' }, [
        h('h1', { style: 'font-size: 2rem; margin-bottom: 0.5rem;' }, 'Tauri + Nuxt Template'),
        h('p', { style: 'color: #666; font-size: 1.1rem; margin-bottom: 2rem;' },
        ...
        h('p', { style: 'color: #666; line-height: 1.6;' }, [
          ...
          h('code', { style: 'background: #f0f0f0; padding: 2px 6px; border-radius: 4px;' }, 'app/components/'),
          '. Each component has a co-located ',
          h('code', { style: 'background: #f0f0f0; padding: 2px 6px; border-radius: 4px;' }, '.stories.ts'),
        ...
        h('h2', { style: 'font-size: 1.3rem; margin-top: 1.5rem; margin-bottom: 0.5rem;' }, 'Learn More'),
        h('ul', { style: 'color: #666; line-height: 2; list-style: none; padding: 0;' }, [
          h('li', {}, [
            h('a', { href: 'https://storybook.js.org/docs', target: '_blank', style: 'color: #667eea;' }, 'Storybook Documentation'),
          ]),
          h('li', {}, [
            h('a', { href: 'https://v2.tauri.app', target: '_blank', style: 'color: #667eea;' }, 'Tauri v2 Documentation'),
          ]),
          h('li', {}, [
            h('a', { href: 'https://nuxt.com/docs', target: '_blank', style: 'color: #667eea;' }, 'Nuxt Documentation'),
          ]),
        ]),
      ])
  },
